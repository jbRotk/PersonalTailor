...
<div class="wrapper">
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> 修改密码</a></li>
                        </ul>
                    </li>
    ...
    <ul class="treeview-menu">
        <li class="active"><a href="<?php echo U('ManufactorAdmin/Store/storesetting');?>"><i class="fa fa-circle-o"></i> 店铺信息管理</a></li>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-6">
                                    <form role="form" action="<?php echo U('ManufactorAdmin/Store/setInfo_feedback');?>" method="post">
