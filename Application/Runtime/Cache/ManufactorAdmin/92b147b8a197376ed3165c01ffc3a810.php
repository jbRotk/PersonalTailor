...
<div class="wrapper">
    ...
    <li class="active treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo U('ManufactorAdmin/Product/list_down_products');?>"><i class="fa fa-circle-o"></i>下架商品列表</a></li>
                        ...
                        <div class="box-body">
                            ...
                            <table class="table no-margin">
                                ...
                                <?php if(is_array($products)): $i = 0; $__LIST__ = $products;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="col-md-2 text-center">
                                            <div>
                                                <a href="javascript:;" data-toggle="modal" data-target="#down-product" data-id="<?php echo ($arr["id"]); ?>" class="down-product"><i class="ion-minus-circled"></i>&nbsp;上架产品</a>
                        ...
                        <div class="modal fade" id="down-product"  role="modal" aria-hidden="true">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        确认上架吗 <span data-bind="text: opItem().name"></span>?
                                    </div>
                                    <div class="modal-footer">
                                        <button  type="button" class="btn" data-dismiss="modal">取消</button>
